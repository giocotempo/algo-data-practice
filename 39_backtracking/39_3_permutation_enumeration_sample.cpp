...
void back_track(const std::vector<std::string>& arr, std::vector<std::string>& candidates,
                std::unordered_set<std::string>& used, std::vector<std::vector<std::string>>& output) {
