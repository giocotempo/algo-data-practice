...
bool enduring_best_seller_streak(vector<string> best_seller, int k) {
    int l = 0, r = 0;
    int cur = 0;
...
int main() {
    vector<string> best_seller = {"book3", "book1", "book3", "book3", "book2"};
    int k = 3;
    cout << (enduring_best_seller_streak(best_seller, k) ? "true" : "false") << endl;
